defmodule UnterEatsWeb.GraphQLCase do
  @moduledoc """
  ...
  defmacro __using__(opts \\ []) do
    ...
    quote do
      ...
      import UnterEatsWeb.GraphQLCase
      import UnterEatsWeb.ConnCase
      import Phoenix.ConnTest
      import ShorterMaps

      setup tags do
        :ok = Sandbox.checkout(UnterEats.Repo)

        Absinthe.Test.prime(@__schema__)

        unless tags[:async] do
          Sandbox.mode(UnterEats.Repo, {:shared, self()})
        end
  ...
  def query(document, variables \\ %{}) do
    ...
    Absinthe.run!(document, UnterEatsWeb.Api.Schema, opts)
  end
  ...
  def query_with_user(document, user, variables \\ %{}) do
    ...
    case Absinthe.run!(document, UnterEatsWeb.Api.Schema, opts) do
  ...
  def conn_for_user(%UnterEats.Users.User{} = user) do
