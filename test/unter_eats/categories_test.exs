defmodule UnterEats.CategoriesTest do
  ...
  describe "categories" do
    ...
    import UnterEats.CategoriesFixtures

    @invalid_attrs %{name_en: nil, name_pl: nil, slug: nil}
    ...
    test "create_category/1 with valid data creates a category" do
      valid_attrs = %{name_en: "some name_en", name_pl: "some name_pl", slug: "some slug"}

      assert {:ok, %Category{} = category} = Categories.create_category(valid_attrs)
      assert category.name_en == "some name_en"
      assert category.name_pl == "some name_pl"
    ...
    test "update_category/2 with valid data updates the category" do
      category = category_fixture()
      update_attrs = %{name_en: "some updated name_en", name_pl: "some updated name_pl", slug: "some updated slug"}

      assert {:ok, %Category{} = category} = Categories.update_category(category, update_attrs)
      assert category.name_en == "some updated name_en"
      assert category.name_pl == "some updated name_pl"
